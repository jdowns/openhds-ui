...
public interface UserClient {
    @RequestLine("GET /users.json")
    OpenHdsRestResponse<Response> get();

    @RequestLine("GET /users/bulk.json")
    ...
    @RequestLine("GET /users/byLocationhierarchy.json")
    ...
    @RequestLine("GET /users/byLocationhierarchy/bulk.json")
    /* Valid params are locationHierarchyUuid,afterDate,beforeDate */
    OpenHdsRestResponse<Response> getAllFilteredByLocationHierarchy(@QueryMap Map<String, Object> params);

    @RequestLine("GET /users/voided")
    Response getVoided();

    @RequestLine("POST /users")
    Response create(Request request);

    @RequestLine("GET /users/{id}.json")

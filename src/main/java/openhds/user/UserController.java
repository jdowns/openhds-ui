...
//public class UserController implements openhds.Controller<User, Request> {
//
//    @Autowired UserClient userClient;
//    @Autowired FieldWorkerClient fieldWorkerClient;
//
//    @Override
//    @RequestMapping(value="/", method=RequestMethod.POST)
//    public ResponseEntity<User> create(@RequestBody Request request) {
//        return ResponseEntity.status(HttpStatus.CREATED).body(userClient.create(request));
//    }
//
//    @Override
//    @RequestMapping(value="/", method=RequestMethod.GET)
//    public ResponseEntity<List<User>> get(@RequestParam(name = "page", defaultValue = "1L") Long page,
...
//        return ResponseEntity.status(HttpStatus.OK).body(userClient.get(filterParams).getContent());
//    }
//
//    @Override

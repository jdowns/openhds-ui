...
angular.module('openHDS.core', ['ngRoute']).config(['$httpProvider', corsConfig]).config(['$routeProvider', routeConfig]);

angular.module('openHDS.model', ['openHDS.core']).config(['$httpProvider', corsConfig]);

angular.module('openHDS.view', ['openHDS.core', 'openHDS.model']).config(['$httpProvider', corsConfig]);
